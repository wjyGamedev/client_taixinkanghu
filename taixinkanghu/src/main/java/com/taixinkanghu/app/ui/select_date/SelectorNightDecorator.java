...
public class SelectorNightDecorator extends BaseSelectorDecorator
{
	private final Drawable m_drawable;
	private BaseSelectorDecorator.OnShouldDecorateListener m_onShouldDecorateListener = null;

	public SelectorNightDecorator()
	{
		m_drawable = AppUtil.GetResources().getDrawable(R.drawable.night);
	}
