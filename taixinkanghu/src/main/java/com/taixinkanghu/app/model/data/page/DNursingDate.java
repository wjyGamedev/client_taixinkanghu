...
public class DNursingDate
{
	...
	public DNursingDate(Date beingDate, Date endDate,
						ArrayList<Calendar>           allCalendarList,
						ArrayList<Calendar>           dayCalendarList,
						ArrayList<Calendar>           nightCalendarList,
						String dateDescription
						)
	{
		m_beingDate = beingDate;
