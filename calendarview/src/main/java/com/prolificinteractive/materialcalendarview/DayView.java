...
class DayView extends CheckedTextView
{
	...
	private final int DAY_TEXT_PADDING_TOP    = 8;
	private final int DAY_TEXT_PADDING_BOTTOM = 0;
	private final int DAY_TEXT_PADDING_LEFT   = 0;
	private final int DAY_TEXT_PADDING_RIGHT  = 0;
	...
	public DayView(Context context, CalendarDay day)
	{
		...
		setPadding(DAY_TEXT_PADDING_LEFT, DAY_TEXT_PADDING_TOP, DAY_TEXT_PADDING_RIGHT, DAY_TEXT_PADDING_BOTTOM);
